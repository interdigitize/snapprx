...
var   	async = require("async"),		// async module
	...
	email = "saadmir@gmail.com",				// your account email
	password = "Tie@sign1",			// your account password
	integratorKey = "c33d6eb9-eb44-4d7e-86a7-a6c27350396b",			// your account Integrator Key (found on Preferences -> API page)
	recipientName = "Dr. Who",			// recipient (signer) name
	templateId = "bdf7b483-bd33-4ba3-bbba-6a495098ac21",			// provide valid templateId from a template in your account
	templateRoleName = "self",		// template role that exists on template referenced above
